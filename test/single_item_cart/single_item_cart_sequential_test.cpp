...
#include <gtest/gtest.h> // for AssertionResult, Test, Message, TestPartResult, EXPECT_TRUE, Cmp...

#include <cstddef> // for size_t
#include <string>  // for basic_string
#include <utility> // for pair, get

#include <scq/slotted_cart_queue.hpp> // for slot_id, slotted_cart_queue, span, cart_future, cart_capacity
