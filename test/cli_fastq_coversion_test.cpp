...
{
    app_test_result const result = execute_app("shopping_cart_queue");
...
{
    app_test_result const result = execute_app("shopping_cart_queue", "-v");
...
{
    app_test_result const result = execute_app("shopping_cart_queue", data("in.fastq"));
...
{
    app_test_result const result = execute_app("shopping_cart_queue", data("in.fastq"), "-v");
...
{
    app_test_result const result = execute_app("shopping_cart_queue", data("in.fastq"), "-o", "out.fasta");
...
{
    app_test_result const result = execute_app("shopping_cart_queue", data("in.fastq"), "-o", "");
...
{
    app_test_result const result = execute_app("shopping_cart_queue", data("in.fastq"), "-o", "does_not_exist/out.fasta");
